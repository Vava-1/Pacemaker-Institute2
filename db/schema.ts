...
export const exercises = mysqlTable("exercises", {
  ...
  type: mysqlEnum("type", ["multiple_choice", "fill_blank", "matching", "true_false"]).default("multiple_choice").notNull(),
...
export const notifications = mysqlTable("notifications", {
  id: bigint("id", { mode: "number", unsigned: true }).primaryKey().autoincrement(),
  userId: bigint("user_id", { mode: "number", unsigned: true }).notNull(),
  type: mysqlEnum("type", ["course", "exercise", "badge", "liveClass", "message", "payment", "system"]).default("system"),
  title: varchar("title", { length: 255 }).notNull(),
...
export const badges = mysqlTable("badges", {
  ...
  requirementType: mysqlEnum("requirement_type", ["exercises", "streak", "courses", "hours", "score"]).default("exercises"),
